...
import { FileText, Image, Video, Link, Upload, Search, Loader2 } from "lucide-react";
...
const ContentAnalyzer = () => {
  ...
  const { isAnalyzing, results, analyzeText, analyzeImage, analyzeURL, resetResults } = useAIAnalysis();
  ...
  const handleTextAnalysis = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Content has been analyzed for potential misinformation."
      });
    } catch (error) {
      toast({
        title: "Analysis failed",
        description: "There was an error analyzing the content. Please try again.",
        variant: "destructive"
      });
    }
  };
  ...
  const handleImageAnalysis = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Image has been analyzed for potential manipulation."
      });
    } catch (error) {
      toast({
        title: "Analysis failed",
  ...
  const handleUrlAnalysis = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Website has been analyzed for credibility."
      });
    } catch (error) {
      toast({
        title: "Analysis failed",
